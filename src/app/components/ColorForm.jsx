...
import { changeColor, resetColor, changeLang, toggleAdvOpt } from "../action-creators.js"
    ...
    return (
      <div className="form__wrapper">
        <div className="form">
          ...
          <button id="buildColors" className="form__btn btn" onClick={this.buildColors} style={styleBtnBuild}>
            { __().btnValidate }
          </button>
